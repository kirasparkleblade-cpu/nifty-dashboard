...
// FALLBACK: Yahoo v8 chart with cookie+crumb auth — kept in case NSE itself
// is rate-limiting at the moment of the request.
//
...
async function fetchFromYahoo() {
  ...
  const url = `https://query1.finance.yahoo.com/v8/finance/chart/%5ENSEI?interval=1d&range=1d&crumb=${encodeURIComponent(
    session.crumb
  )}`;
